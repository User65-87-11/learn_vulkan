...
void main()
{
    ...
    else if (id == 3) { pos = vec3( L,  0.0, 0.0); col = vec4(1.0, 0.0, 0.0,fragAlpha);  fragAlpha = 1.0;}

    // Y Axis (Green)
    else if (id == 4) { pos = vec3(0.0, -L/50,  0.0); col = vec4(0.2, 1.0, 0.2,fragAlpha); }
    else if (id == 5) { pos = vec3(0.0,  0.0, 0.0); col = vec4(0.2, 1.0, 0.2,fragAlpha); }
    else if (id == 6) { pos = vec3(0.0,  0.0, 0.0); col = vec4(0.2, 1.0, 0.2,fragAlpha); }
