...
@REM glslangValidator -V -S vert ./shaders/vert_hud.glsl -o ./shaders/out/vert_hud.spv -e main



@REM glslangValidator -V -S frag ./shaders/frag_shadow.glsl -o ./shaders/out/frag_shadow.spv -e main

@REM glslangValidator -V -S vert ./shaders/vert_shadow.glsl -o ./shaders/out/vert_shadow.spv -e main