...
#define BINDING_VIEW_PROJECTIONS 2
#define BINDING_MODELS 3
#define BINDING_DIRECTIONAL_LIGHTS 4
#define BINDING_OBJECT_IDS 5
#define BINDING_2D_COLORS 6

#define BINDING_MAX 7
