...
#define BUFFER_SSBO_USAGE VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT
...
#define BUFFER_VERTEX_USAGE  VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_VERTEX_BUFFER_BIT
#define BUFFER_VERTEX_PROPS  VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT

#define BUFFER_INDEX_USAGE VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT
#define BUFFER_INDEX_PROPS  VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT

#define IMAGE_TEXTURE_USAGE VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_TRANSFER_SRC_BIT
...
void Resource_CreateImageView(struct Image * img, VkImageAspectFlagBits aspectFlags);
