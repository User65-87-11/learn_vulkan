...
#define DEFAULT_SHADER_VERT "shaders/out/main.vert.spv"
#define DEFAULT_SHADER_FRAG "shaders/out/main.frag.spv"


#define HUD_SHADER_VERT "shaders/out/hud.vert.spv"
